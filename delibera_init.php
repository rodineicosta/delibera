...
function delibera_Add_custom_taxonomy()
{
    ...
    if (file_exists(__DIR__.DIRECTORY_SEPARATOR.'delibera_taxs.php')) {
        include_once __DIR__.DIRECTORY_SEPARATOR.'delibera_taxs.php';
    }
...
{
    include_once dirname(__FILE__).'/modules/modulebase.php';
...
if (array_key_exists('plan_restriction', $conf) && $conf['plan_restriction'] == 'S') {
    include_once __DIR__.DIRECTORY_SEPARATOR.'delibera_plan.php';
}
...
function delibera_config_menu()
{
    ...
    if (function_exists('add_menu_page')) {
        add_menu_page(__('Delibera', 'delibera'), __('Delibera', 'delibera'), 'manage_options', $base_page, array(), WP_PLUGIN_URL."/delibera/images/delibera_icon.png");
 ...
 * @param array  $term    EX: array('description'=> __('Español'),'slug' => 'espanol', 'slug'
 *                        => 'espanol')
 * @param array  $idiomas EX: array('qtrans_term_en' => 'United States of America', 'qtrans_term_pt' => 'Estados Unidos da América', 'qtrans_term_es' => 'Estados Unidos de
 *                        América'
 */
