...
foreach ($wp_posts as $wp_post)
{
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <h2 class="entry-title delibera-widget-entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'delibera'), the_title_attribute('echo=0')); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
    <?php
