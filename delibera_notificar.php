...
function delibera_notifications_page()
{
    ...
    {
        delibera_nofiticar_config_page_create_checkbox(
            $rows,
...
function delibera_get_notification_config($config = array())
{
    ...
    $opt['mensagem_fim_prazo_validacao'] = __(
        'Olá {display_name},
    ...
    $opt['mensagem_fim_prazo_discussao'] = __(
        'Olá {display_name},
    ...
    $opt['mensagem_fim_prazo_votacao'] = __(
        'Olá {display_name},
    ...
    $opt['mensagem_data_externa_vencida'] = __(
        'Olá {display_name},
...
function delibera_notificar_representantes($mensage, $tipo, $post = false, $users = false, $link = false, $admin = false)
{
    ...
    if ((is_object($post) && $post->post_status == 'publish') || $admin) {
        ...
        if ($options_plugin_delibera["notificacoes"] == "N"  // Notificações estão desabilitadas OU
